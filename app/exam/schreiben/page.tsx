...
import { LongTextQuestion } from '@/components/exam/long-text-question';
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Write detailed responses following the given constraints
              </p>
            </div>
            <ExamTimer />
          </div>
          ...
          <div className="space-y-4">
            ...
            <LongTextQuestion question={currentQuestion} />
          </div>
